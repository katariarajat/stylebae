...
<span id="error_msg">
        ...
        <h4 style="float: right;">{{$get_products->product_name_en}}</h4>
            ...
            <div class="controls">
                <input type="text" name="date_app" class="cal_input" id="mydate" placeholder="dd-mm-yy" > 
        ...
        <div class="time">
          ...
          <div class="choose">
              ...
              <div class="form-group">
                 ...
                 <input type="text" class="form-control" name="service_price" id="priceinp" value="Rs {{$get_services->price}}" readonly>
              </div>
              <div class="form-group">
                <label for="date"> Date</label>
                <input type="text" class="form-control" name="date_app" id="dateinp" id="date_app" aria-describedby="emailHelp"readonly>
                <label for="date"> Time</label>
                <input type="text" class="form-control" name="time_app" id="timeinp" aria-describedby="emailHelp"readonly>
               
              </div>
              
               <input type="submit" value="Confirm" class="btn btn-primary" id="app-add" onclick="existappointment()" >
